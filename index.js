...
const totalContributions = GAMES_JSON.reduce( (acc, game) => {
    return acc + game.backers; //game.backers same as GAMES_JSON[game].backers
}, 0);
...
const displayStr = `
    ...
    ${numOfUnfundedGames===1 ? "1 game remains unfunded" : numOfUnfundedGames+" games remain unfunded."}
